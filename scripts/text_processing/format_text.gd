...
static func format_verse(book:String, chapter:int, verse:int, verse_text:String)->String:
	...
	var colon_text_formatted:String = cmd_style.color_tertiary_text(":")
	var hyphen_text_formatted:String = cmd_style.color_tertiary_text("-")
	return "%s %s%s%s %s %s" % [book_formatted, chapter_formatted, colon_text_formatted, verse_formatted, hyphen_text_formatted, verse_text_formatted]
